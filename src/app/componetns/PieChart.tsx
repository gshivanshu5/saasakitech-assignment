...
const PieChart = () => {
  ...
  return (
    <div className="p-4 max-w-[500px] mx-auto">
      <h1 className="font-bold text-[40px] mb-7">Pie Chart</h1>
      <div className="mb-4">
      ...
      <div
        className={`transition-transform duration-300 ease-in-out ${isHovered ? 'transform scale-105' : 'transform scale-100'} h-[500px] mb-4`}
